...
#    fig.add_trace(go.Scatterpolar(
#            r = np.array([0.0,1.0]),
#            theta = np.array([vPhases2[i],vPhases2[i]]),
#            mode = 'lines+markers',
#            marker={'symbol':"circle", 'size':16},
#            name = '{:0.1f}'.format(vPhases2[i]),
#            text=['{:0.1f}'.format(vPhases2[i])],
#            textposition="bottom center",
#            line_color= px.colors.qualitative.Dark2[2],
#            line={'width':7, 'dash':'dash'},
#            legendgroup='Referee #2',
#            legendgrouptitle_text='Referee #2',
#            showlegend=True,
#            ))
...
#for comparing vSlices - HEAT method
##deuterium
#ionMassAMU = 2.0
##electrons
